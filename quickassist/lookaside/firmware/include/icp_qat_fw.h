...
typedef struct icp_qat_fw_comn_resp_hdr_s
{
     ...
     * Bit<3> = 'Is iCRC calculated by DCPR' flag indicating that whether
     *          iCRC calculated by DCPR
...
#define ICP_QAT_FW_COMN_HDR_RESRVD_FLD_MASK 0x3F
 ...
 * @param invparam Value of the Invalid parameter flag
 * @param xlt      Value of the Translation marker flag
 *****************************************************************************/
#define ICP_QAT_FW_COMN_RESP_STATUS_BUILD(                                     \
    crypto, pke, comp, xlat, eolb, unsupp, invparam, xlt)                      \
    ((((crypto)&QAT_COMN_RESP_CRYPTO_STATUS_MASK)                              \
     ...
     (((invparam)&QAT_COMN_RESP_INVALID_PARAMETER_MASK)                        \
