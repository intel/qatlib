...
| Resolution    | Do not enable verifyHwIntegrityCrcs if the payload is spread across multiple flat buffers in the buffer list and a 64bit programmable CRC is needed. |
| Affected OS   | Linux |
