...
|----------|:-------------:|------:|:------|
| November 2023 | 011 | 23.11 | - Support DC NS (NoSession) APIs.  <br> - Support  DC compressBound APIs. <br> - Support Symmetric Crypto SM3 & SM4. <br> - Support Asymmetric Crypto SM2. <br> - The ABI version changed in this release, so the shared object version (liqat.so) is incremented in this release. <br> - Bug Fixes. See [Resolved Issues](#resolved-issues). |
